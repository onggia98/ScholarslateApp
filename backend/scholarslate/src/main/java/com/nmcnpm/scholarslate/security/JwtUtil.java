 ...
 * Algorithm: HMAC-SHA256. TTL: 24 giờ (86400000ms).
 * Logout phía client xóa token khỏi storage — không có refresh token.
 */
@Component
public class JwtUtil {
    ...
    public JwtUtil(
        ...
        // Key phải đủ 256 bit (32 bytes) cho HMAC-SHA256
